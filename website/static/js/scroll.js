...
(function (scroll_x) {
  window.addEventListener("load", function () {
    ...
    if (media_infograph) {
      ...
      document.getElementById('media_infograph_R').addEventListener("click", media_infograph_scroll.right);
      document.getElementById('media_infograph_L').addEventListener("click", media_infograph_scroll.left);
    }
    ...
    if (media_videos) {
      ...
      document.getElementById('media_videos_R').addEventListener("click", media_videos_scroll.right);
      document.getElementById('media_videos_L').addEventListener("click", media_videos_scroll.left);
    }
  })
})(function (element) {
